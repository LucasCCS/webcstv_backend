...
<section class="invl-plans">
    <div class="container">
           ...
           <div class="col-sm-12 col-md-12 col-lg-6">
                <div class="invl-plans-nav">
                    <ul class="invl-plans-nav-list nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-plano-iptv-mes-tab" data-toggle="pill" href="#pills-plano-iptv-mes" role="tab" aria-controls="pills-plano-iptv-mes" aria-selected="true">Plano Mensal</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-plano-iptv-trimestral-tab" data-toggle="pill" href="#pills-plano-iptv-trimestral" role="tab" aria-controls="pills-plano-iptv-trimestral" aria-selected="false">Plano Trimestral</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-plano-iptv-semestral-tab" data-toggle="pill" href="#pills-plano-iptv-semestral" role="tab" aria-controls="pills-plano-iptv-semestral" aria-selected="false">Plano Semestral</a>
                        </li>
                    </ul>
                </div>
           </div>
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-plano-iptv-trimestral" role="tabpanel" aria-labelledby="pills-plano-iptv-trimestral-tab">
                <div class="invl-plans-list"  style="margin-top: 10px;">   
                    <div class="row">
                        <?php
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-3">
                            <div class="invl-plans-list-item">
                                ...
                                <div class="invl-plans-list-item-body">
                                    ...
                                    <div class="invl-plans-list-item-action text-center">
                                        <button type="button" class="btn btn-primary btn-plans btn-block" selectPlan="<?=$iptv_trimestral->id_plano;?>" selectPlanPer="<?=$iptv_trimestral->id_sub_plano;?>">Teste Grátis</button>
                                        <small class="text-muted mr-1 ml-1">Teste hoje mesmo, sem nenhum custo.</small>
                                    </div>
                                    <div class="invl-plans-list-item-features">
                                        <ul class="invl-plans-list-item-features-list">
            ...
            <div class="tab-pane fade" id="pills-plano-iptv-semestral" role="tabpanel" aria-labelledby="pills-plano-iptv-semestral-tab">
                <div class="invl-plans-list"  style="margin-top: 10px;">   
                    <div class="row">
                        <?php
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-3">
                            <div class="invl-plans-list-item">
                                ...
                                <div class="invl-plans-list-item-body">
                                    ...
                                    <div class="invl-plans-list-item-action text-center">
                                        <button type="button" class="btn btn-primary btn-plans btn-block" selectPlan="<?=$iptv_semestral->id_plano;?>" selectPlanPer="<?=$iptv_semestral->id_sub_plano;?>">Teste Grátis</button>
                                        <small class="text-muted mr-1 ml-1">Teste hoje mesmo, sem nenhum custo.</small>
                                    </div>
                                    <div class="invl-plans-list-item-features">
                                        <ul class="invl-plans-list-item-features-list">
