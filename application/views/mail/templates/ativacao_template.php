            ...
            <div class="mail">
                ...
                <div class="mail-content">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <th scope="row" class="table-title">Url(s):</th>
                                <td colspan="2">
                                    <?php 
                                        foreach($operadoras as $key) {
                                            echo '<p>['.$key->titulo.']: '.$key->url.'</p>';
                                        }
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="table-title">Porta(s)</th>
                                <?php 
                                    foreach($operadoras as $key) {
                                        echo '<p>['.$key->titulo.']: '.$key->porta.'</p>';
                                    }
                                ?>
                            </tr>
                            <tr>
                                <th scope="row" class="table-title">Usuário</th>
                                <td colspan="2">
                                    <?=$cliente_servidor['usuario'];?>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="table-title">Senha</th>
                                <td colspan="2">
                                    <?=$cliente_servidor['senha'];?>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="table-title">Chave DES</th>
                                <td colspan="2">
                                    <?=$cliente['chave_des'];?>
                                </td>
                            </tr>
                    ...
                    <br><br>
                    <h4>Dicas</h4>
                    <p>Apos efetuar seu teste, e quiser efetivar sua conta conosco, acesse sua conta clicando no botão abaixo:</p>
                    <a href="<?=$site_url;?>" class="mail-btn">Acessar Painel</a>
