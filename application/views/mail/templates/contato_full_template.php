        ...
        <div class="col-md-4 offset-md-3">
            <div class="mail">
                ...
                <div class="mail-content">
                    <h2>Olá caro administrador</span>,</h2>
                    <p>Nova mensagem recebida através do formulário de contato:</p>
                    <hr>                  
                    <div class="mail-contact-data">
                        <ul>
                            <li>Nome: <?=$contato['nome'];?></li>
                            <li>E-mail: <?=$contato['email'];?></li>
                            <li>Telefone: <?=$contato['telefone'];?></li>
                            <li><?=$contato['cidade'];?>, <?=$contato['estado'];?></li>
                            <li>Mensagem:
