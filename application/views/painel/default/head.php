...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        <?=$this->load->view('painel/default/header',[],TRUE);?>
        <?php
            if($this->uri->segment(2) == "produto" && $this->uri->segment(3) != "novo") {
                echo $this->load->view('painel/produto/default/sidenav',[],TRUE);
            } else {
                echo $this->load->view('painel/default/sidenav',[],TRUE);
            }
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor"><?php if(isset($titulo)): echo $titulo; endif;?></h3>
                    </div>
                </div>
    <?php endif;?>