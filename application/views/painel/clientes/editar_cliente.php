            ...
            <div class="card-block">
                ...
                <form method="post">
                    <div class="row">
                        <div class="col-12">
                            <label>Nome</label>
                            <input class="form-control form-control-lg" type="text" name="nome" value="<?=$cliente['nome'];?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <label>E-mail</label>
                            <input class="form-control form-control-lg" type="text" name="email" value="<?=$cliente['email'];?>">
                            <small>Utilizado como usuário de acesso do cliente.</small>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <label>Telefone</label>
                            <input class="form-control form-control-lg" type="text" name="telefone" value="<?=$cliente['telefone'];?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <select class="form-control form-control-lg" name="id_plano">
                                ...
                                ?>
                                <option value="<?=$key->id_plano;?>" <?php if($key->id_plano == $cliente['id_plano']): echo 'selected'; endif;?>><?=$key->titulo;?></option>
                                <?php                                          
                                        }
                                    }
                                ?>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <select class="form-control form-control-lg" name="id_metodo_pagamento">
                                ...
                                ?>
                                <option value="<?=$key->id_metodo_pagamento;?>" <?php if($key->id_metodo_pagamento == $cliente['id_metodo_pagamento']): echo 'selected'; endif;?>><?=$key->titulo;?></option>
                                <?php
                                        }
                                    }
                                ?>
                    ...
                    <input class="btn btn-success" type="submit" name="editar_cliente" value="Salvar">
                </form>
            </div>
        </div>
    </div>
